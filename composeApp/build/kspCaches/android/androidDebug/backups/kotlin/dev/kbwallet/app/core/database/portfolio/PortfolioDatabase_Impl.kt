...
import dev.kbwallet.app.portfolio.`data`.local.TransactionDao_Impl
...
public class PortfolioDatabase_Impl : PortfolioDatabase() {
  ...
  protected override fun createOpenDelegate(): RoomOpenDelegate {
    val _openDelegate: RoomOpenDelegate = object : RoomOpenDelegate(3,
        "d1538245f6db419ee761d6a904a17396", "b1b8102a448af2bce27ef4ca16f7ea6c") {
      public override fun createAllTables(connection: SQLiteConnection) {
        ...
        connection.execSQL("CREATE TABLE IF NOT EXISTS `transactions` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `type` TEXT NOT NULL, `coinId` TEXT NOT NULL, `coinName` TEXT NOT NULL, `coinSymbol` TEXT NOT NULL, `amountFiat` REAL NOT NULL, `amountCrypto` REAL NOT NULL, `price` REAL NOT NULL, `timestamp` INTEGER NOT NULL)")
        connection.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)")
        connection.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'd1538245f6db419ee761d6a904a17396')")
      }
      ...
      public override fun onValidateSchema(connection: SQLiteConnection):
        ...
        _columnsTransactions.put("type", TableInfo.Column("type", "TEXT", true, 0, null,
            TableInfo.CREATED_FROM_ENTITY))
        _columnsTransactions.put("coinId", TableInfo.Column("coinId", "TEXT", true, 0, null,
            TableInfo.CREATED_FROM_ENTITY))
        _columnsTransactions.put("coinName", TableInfo.Column("coinName", "TEXT", true, 0, null,
            TableInfo.CREATED_FROM_ENTITY))
        _columnsTransactions.put("coinSymbol", TableInfo.Column("coinSymbol", "TEXT", true, 0, null,
            TableInfo.CREATED_FROM_ENTITY))
        _columnsTransactions.put("amountFiat", TableInfo.Column("amountFiat", "REAL", true, 0, null,
            TableInfo.CREATED_FROM_ENTITY))
        _columnsTransactions.put("amountCrypto", TableInfo.Column("amountCrypto", "REAL", true, 0,
            null, TableInfo.CREATED_FROM_ENTITY))
        _columnsTransactions.put("price", TableInfo.Column("price", "REAL", true, 0, null,
            TableInfo.CREATED_FROM_ENTITY))
        ...
        if (!_infoTransactions.equals(_existingTransactions)) {
          return RoomOpenDelegate.ValidationResult(false, """
              |transactions(dev.kbwallet.app.portfolio.data.local.TransactionEntity).
              | Expected:
  ...
  protected override fun createInvalidationTracker(): InvalidationTracker {
    ...
    return InvalidationTracker(this, _shadowTablesMap, _viewTables, "PortfolioCoinEntity",
        "UserBalanceEntity", "transactions")
  }

  public override fun clearAllTables() {
    super.performClear(false, "PortfolioCoinEntity", "UserBalanceEntity", "transactions")
  }
